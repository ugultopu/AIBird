...
# Run PonyGE2 script
cd PonyGE2/src
nohup python3 ponyge.py --parameters ai_birds.txt --file_path "$directory" &> "../$directory/output.txt" &
...
cd ../..
nohup python3 AIBird/src/python/enumerate-structures.py "AIBird/$directory" "PonyGE2/$directory/positions.txt" &> "AIBird/$directory/output.txt" &
