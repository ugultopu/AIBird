...
# Pass the generated directory's path to the script. Also pass 'silhouette.txt'
# from the last run of PonyGE2
cd ../..
python3 AIBird/src/python/enumerate-structures.py "AIBird/$directory" "PonyGE2/$directory/silhouette.txt" &> "AIBird/$directory/output.txt" &
