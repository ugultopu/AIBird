...
# The path to the file that contains the positions
positions="$1"
...
python3 AIBird/src/python/enumerate-structures.py "AIBird/$directory" "$positions" &> "AIBird/$directory/output.txt" &
